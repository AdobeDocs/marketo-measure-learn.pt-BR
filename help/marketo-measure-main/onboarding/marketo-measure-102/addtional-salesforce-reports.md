...
description: Esta lição aborda os relatórios de atribuição personalizados no Salesforce CRM.
role: User
level: Beginner
...
Esta lição aborda os relatórios de atribuição personalizados no Salesforce CRM.
